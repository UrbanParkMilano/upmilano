  ...
  <Layout>
   ...
   <Row>
    ...
    <h2>Periodo di conservazione</h2>
        ...
        <p>Pertanto, allo spirare di tale termine il diritto di accesso, cancellazione, rettificazione ed il diritto alla portabilità dei Dati non potranno più essere esercitati.</p>
        <h2>Finalità del Trattamento dei Dati raccolti</h2>
        <p>I Dati dell’Utente sono raccolti per consentire al Titolare di fornire i propri Servizi, così come per le seguenti finalità: Contattare l’Utente. Per ottenere ulteriori informazioni dettagliate sulle finalità del trattamento e sui Dati Personali concretamente rilevanti per ciascuna finalità, l’Utente può fare riferimento alle relative sezioni di questo documento.</p>
    </Row>
    <Row>
    ...
    <Row>   
        ...
        <p>ricevere i propri Dati o farli trasferire ad altro titolare. L’Utente ha diritto di ricevere i propri Dati in formato strutturato, di uso comune e leggibile da dispositivo automatico e, ove tecnicamente fattibile, di ottenerne</p>
        <p>il trasferimento senza ostacoli ad un altro titolare. Questa disposizione è applicabile quando i Dati sono trattati con strumenti automatizzati ed il trattamento è basato sul consenso dell’Utente, su un contratto di cui l’Utente è parte o su misure contrattuali ad esso connesse.</p>
    ...
    <h2>Dettagli sul diritto di opposizione</h2>
        ...
        <p>Come esercitare i diritti Per esercitare i diritti dell’Utente, gli Utenti possono indirizzare una richiesta agli estremi di contatto del Titolare inviando:</p>
        <p>– una e-mail all’indirizzo info@urbanparkmilano.com</p>
    </Row>    
    <Row>
    <h2>Ulteriori informazioni sul trattamento</h2>
        ...
        <p>Questa Applicazione non supporta le richieste “Do Not Track”. Per scoprire se gli eventuali servizi di terze parti utilizzati le supportino, l’Utente è invitato a consultare le rispettive privacy policy.</p>
    ...
    <h2>Plugin Social Network</h2>
        ...
        <p>La raccolta e l'uso delle informazioni ottenute a mezzo del plugin sono regolati dalle rispettive informative privacy dei social network.</p>
     </Row>
   ...
   <Row>
    ...
    <Row>
        <p>Un cookie è un breve testo inviato al tuo browser da un sito web visitato. Consente al sito di memorizzare informazioni sulla tua visita, come la tua lingua preferita e altre impostazioni. Ciò può facilitare la tua visita successiva e aumentare l’utilità del sito.</p>
        <p>I cookie vengono utilizzati per vari scopi ad esempio per memorizzare le tue preferenze, per contare il numero di visitatori, per le procedure di registrazione e autenticazione, etc.</p>
        <p>I cookie di sessione sono essenziali per garantire le corrette funzionalità del sito. I cookie di sessione non contengono dati personali e durano per la sola sessione in corso, cioè fino alla chiusura del browser. Per essi non occorre consenso.</p>
        <p>I functionality cookie utilizzati dal sito sono strettamente necessari per l’uso del sito per i quali non occorre alcun consenso.</p>
    </Row>
    <Row>
        <p> <strong>2. Tipologie di cookie utilizzati </strong></p>
    </Row>
    <Row>
        <p>Il presente sito utilizza esclusivamente:</p>
        <p>– cookie di sessione per il corretto funzionamento del sito dal punto di vista della navigazione e della lingua attiva;</p>
        <p>- functionality cookie per gestione della visualizzazione dell’informativa sull’utilizzo dei cookie.</p>
        <p>Utilizzando il sito il visitatore acconsente espressamente all’uso di cookie descritti nella presente informativa.</p>
    </Row>
    <Row>
        <p> <strong>3. Disabilitazione cookie </strong></p>
    </Row>    
    <Row>
        <p>I cookie sono collegati al browser utilizzato e possono essere disabilitati direttamente dal browser,così rifiutando/revocando il consenso all’uso dei cookie. Occorre tenere presente che la disabilitazione dei cookie potrebbe impedire il corretto utilizzo di alcune funzioni del sito stesso.</p>
    </Row>
    <Row>
    <h2>Informativa privacy e cookie Google</h2>
        <p>Per ulteriori informazioni sull’uso dei dati e sul loro trattamento da parte di Google si raccomanda di prendere visione delle informazioni all’apposita pagina predisposta da Google (https://policies.google.com/privacy?hl=it) , e alla pagina sulle Modalità di utilizzo dei dati da parte di Google quando si utilizzano siti o app dei partner (https://policies.google.com/technologies/partnersites?hl=it).</p>
    </Row>
